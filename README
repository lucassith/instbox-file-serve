...
## Overview
Very simple application that allows to serve files from specified directory without access to directory index.

## Usage
```bash
go build -o instbox-file-serve
./instbox-file-serve --dir="<directory which you want to serve>" --port=8000
```
